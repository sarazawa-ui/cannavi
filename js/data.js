...
export const courses = [
  {
    ...
    difficulty: 2,
    satisfaction: 4.5,
    semesterEnrollCount: 156,
    format: "対面",
    classMinutes: 90,
    classroom: "情報棟PC室101",
    textbook: { required: true, name: "Pythonプログラミング入門", price: 2800 },
    difficultyReason: {
      creditRate: 88,
      homeworkLoad: "多い",
  ...
  },
  {
    ...
    difficulty: 3,
    satisfaction: 4.3,
    semesterEnrollCount: 120,
    format: "対面",
    classMinutes: 90,
    classroom: "大教室B201",
    textbook: { required: false, note: "ケース教材・プリント配布" },
    difficultyReason: {
      creditRate: 80,
      homeworkLoad: "普通",
  ...
  },
  {
    ...
    difficulty: 2,
    satisfaction: 4.8,
    semesterEnrollCount: 89,
    format: "ハイブリッド",
    classMinutes: 90,
    classroom: "デザインスタジオD302",
    textbook: { required: false, note: "資料配布・Figma無料版使用" },
    difficultyReason: {
      creditRate: 91,
      homeworkLoad: "普通",
      attendanceStrict: true,
  ...
  },
  {
    ...
    difficulty: 3,
    satisfaction: 4.6,
    semesterEnrollCount: 200,
    format: "対面",
    classMinutes: 90,
    classroom: "大教室A101",
    textbook: { required: true, name: "行動経済学の使い方", price: 2200 },
    difficultyReason: {
      creditRate: 79,
      homeworkLoad: "普通",
      attendanceStrict: false,
  ...
  },
  {
    ...
    difficulty: 4,
    satisfaction: 4.4,
    semesterEnrollCount: 78,
    format: "ハイブリッド",
    classMinutes: 90,
    classroom: "情報棟PC室205",
    textbook: { required: false, note: "資料配布・Jupyter Notebook使用（無償）" },
    difficultyReason: {
      creditRate: 70,
      homeworkLoad: "多い",
      attendanceStrict: false,
  ...
  },
  {
    ...
    difficulty: 2,
    satisfaction: 4.7,
    semesterEnrollCount: 45,
    format: "対面",
    classMinutes: 105,
    classroom: "メディアスタジオM101",
    textbook: { required: false, note: "資料配布・Adobe Premiere Pro使用（学生ライセンス）" },
    difficultyReason: {
      creditRate: 92,
      homeworkLoad: "普通",
      attendanceStrict: true,
  ...
  },
  {
    ...
    difficulty: 4,
    satisfaction: 4.1,
    semesterEnrollCount: 95,
    format: "対面",
    classMinutes: 90,
    classroom: "情報演習室C204",
    textbook: { required: true, name: "心理統計学入門", price: 3200 },
    difficultyReason: {
      creditRate: 68,
      homeworkLoad: "多い",
      attendanceStrict: false,
  ...
  },
  {
    ...
    difficulty: 3,
    satisfaction: 4.9,
    semesterEnrollCount: 60,
    format: "対面",
    classMinutes: 100,
    classroom: "ゼミ室S205",
    textbook: { required: false, note: "資料配布・ゲスト講師資料あり" },
    difficultyReason: {
      creditRate: 82,
      homeworkLoad: "多い",
      attendanceStrict: true,
  ...
  },
  {
    ...
    difficulty: 1,
    satisfaction: 4.2,
    semesterEnrollCount: 180,
    format: "対面",
    classMinutes: 90,
    classroom: "大教室C301",
    textbook: { required: false, note: "プリント配布・資料はLMSで提供" },
    difficultyReason: {
      creditRate: 95,
      homeworkLoad: "少ない",
      attendanceStrict: false,
  ...
  },
  {
    ...
    difficulty: 3,
    satisfaction: 4.7,
    semesterEnrollCount: 140,
    format: "ハイブリッド",
    classMinutes: 90,
    classroom: "大教室C302（一部オンライン併用）",
    textbook: { required: false, note: "資料配布・Google Colabを使用（無償）" },
    difficultyReason: {
      creditRate: 80,
      homeworkLoad: "普通",
      attendanceStrict: false,
  ...
  },
  {
    ...
    difficulty: 2,
    satisfaction: 4.6,
    semesterEnrollCount: 132,
    format: "対面",
    classMinutes: 90,
    classroom: "教育学部棟E201",
    textbook: { required: true, name: "保育と発達心理学入門", price: 2600 },
    difficultyReason: {
      creditRate: 89,
      homeworkLoad: "普通",
      attendanceStrict: true,
  ...
  },
  {
    ...
    difficulty: 2,
    satisfaction: 4.2,
    semesterEnrollCount: 160,
    format: "対面",
    classMinutes: 90,
    classroom: "社会安全学部棟100番教室",
    textbook: { required: false, note: "プリント配布・LMSで資料提供" },
    difficultyReason: {
      creditRate: 87,
      homeworkLoad: "普通",
      attendanceStrict: true,
  ...
  },
  {
    ...
    difficulty: 3,
    satisfaction: 4.5,
    semesterEnrollCount: 165,
    format: "ハイブリッド",
    classMinutes: 100,
    classroom: "4号館401教室（オンライン併用）",
    textbook: { required: false, note: "資料配布・Excel・Python両対応の演習資料あり" },
    difficultyReason: {
      creditRate: 81,
      homeworkLoad: "普通",
      attendanceStrict: false,
...
export function toggleFavorite(courseId) {
  ...
  if (isNowFav) favs.push(courseId);
  else favs.splice(idx, 1);
  localStorage.setItem('cf_favorites', JSON.stringify(favs));
  return isNowFav; // true = 追加, false = 削除
}
